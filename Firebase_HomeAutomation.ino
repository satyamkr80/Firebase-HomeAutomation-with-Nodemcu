...
#define FIREBASE_AUTH "Firebase_database_secret"       //Your Firebase Database Secret goes here
#define WIFI_SSID "sam"             //your WiFi SSID for which yout NodeMCU connects
#define WIFI_PASSWORD "satyam@123"        //Password of your wifi network 
